...
public class PolygonOverlapTest {
    ...
    public void overlapTest() {
        Vector[] vertices = new Vector[]{new Vector(20, -20), new Vector(20, 20),
                new Vector(-20, 20), new Vector(-20, -20)};
        Body polygonA = BodyFactory.createPolygon(30, 30, vertices, Material.STANDARD);
        Body polygonB = BodyFactory.createPolygon(37, 30, vertices.clone(), Material.STANDARD);
        ...
        Body circle = BodyFactory.createCircle(600, 100, 20, Material.STANDARD);
